...
from services.common.location_service import search_location as search_location_service


def register_search_location_tools(mcp_app) -> None:
    ...
    async def search_location(
        ...
        return await search_location_service(
            query=query,
            region=region,
            radius=radius,
        )
